...
export default function Page() {
  ...
  return (
    ...
    >
      <motion.div 
        className="flex items-center gap-2 text-[#7DFA79] mb-4"
      ...
      <motion.h1 
        className="text-3xl md:text-5xl lg:text-6xl font-bold mb-8 md:mb-16"
        variants={itemVariants}
      >
      ...
      >
        ...
        >
          <form className="space-y-6 md:space-y-8" onSubmit={handleSubmit}>
            ...
            <motion.button 
              ...
              className={`w-full md:w-auto bg-white text-black px-8 py-3 rounded-full font-medium transition-opacity ${isSubmitting ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-90'}`}
              variants={itemVariants}
        ...
        {/* Profile Section */}
        <motion.div 
          className="flex-1 order-1 lg:order-2 mb-6 lg:mb-0"
          variants={fadeInUpVariants}
          custom={1}
        >
          <motion.div 
            className="bg-[#1A1A1A] p-5 md:p-6 rounded-2xl"
            whileHover={{ y: -5, transition: { duration: 0.3 } }}
          >
            <motion.div 
              className="inline-flex items-center gap-2 bg-[#253526] text-[#7DFA79] px-3 py-1 md:px-4 md:py-2 rounded-full mb-4 md:mb-6 text-sm md:text-base"
