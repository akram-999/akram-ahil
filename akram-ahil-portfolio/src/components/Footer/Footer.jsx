...
export default function Footer() {
    return (
      <footer className="py-6 px-4 md:px-8 mx-0 md:mx-10 lg:mx-20 mt-8 md:mt-10">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
          ...
          >
            © {new Date().getFullYear()} Akram Ahil. All rights reserved.
          </motion.p>
          ...
          >
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
            >
              <svg width="18" height="18" className="md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
